...
int main ( int argc, char* argv [] )
{
  ...
  perc->NInp = 10; //2 - нейрона, 10 - входов
  perc->Nn = 2;
  perc->Init();
  ...
  cout << "чего больше - нулей или единиц. Если единиц, то " << endl;
  cout << "верный ответ 1 0, если нулей 0 1 " << endl;
  cout << "-------------------------------------------------------- " << endl;
